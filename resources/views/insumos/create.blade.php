        ...
        <div class="modal-body">
          ...
          <div class="mb-3 d-flex align-items-center">
            <div style="flex: 1;">
              ...
              <select name="ID_UnidadMedida" id="ID_UnidadMedida" class="form-control">
                @foreach($unidadMedidas as $unidadMedida)
                  <option value="{{$unidadMedida->id}}"> {{$unidadMedida->nombre}} </option>
                @endforeach
              </select>
            </div>
            <button type="button" class="btn btn-success ml-2" data-toggle="modal" data-target="#createUnidadMedida">
...
<!-- Modal de Agregar Unidad de Medida -->
<div class="modal fade" id="createUnidadMedida" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{route('homeUnidadMedidas.store')}}" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nombre" id="nombreUnidad" 
